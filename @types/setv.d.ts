...
declare namespace setv {
	...
	/**
	 * Retrieves the world position of a game object instance.
	 *
	 * @param vChangeInPlace - vector output
	 * @param go - game object instance
	 */
	...
	/**
	 * Retrieves the local scale of a game object instance.
	 *
	 * @param vChangeInPlace - vector output
	 * @param go - game object instance
	 */
	...
	/**
	 * Retrieves the world scale of a game object instance.
	 *
	 * @param vChangeInPlace - vector output
	 * @param go - game object instance
	 */
	export function get_world_scale(
		vChangeInPlace: vmath.vector3,
		go: GameObject,
	): void;
	 ...
	 * `setv.mul_per_elem(v, a, b) = vmath.vector3(a.x * b.x, a.y * b.y, a.z * b.z)`
	 * @param vChangeInPlace vector output
	 * @param v1  first vector
	 * @param v2  second vector
	 */
	 ...
	 * use `setv.matrix_ortho_inv()` instead.
	 ...
	 * use the general inverse `setv.matrix_inv()` instead.
	 * @param mChangeInPlace  matrix4 output
